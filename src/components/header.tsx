...
export default function Header() {
    const pagesNames = ["Pre Deti", "Pre Tínedžeri", "Pre Dospelí", "Pre Starší ľudia", "SWOT", "Gantt", "Business Plan", "Finančná analýza"," Analýza rizík", "Plán riadenia kvality", "Komunikačný plán"]
    const pagesArr = ["/training/children", "/training/teenagers", "/training/adults", "/training/olds", "/swot", "/gantt", "/plan", "/finance_analyze", "/analyza_rizik", '/plan_kvality', '/komunikacny_plan'];
